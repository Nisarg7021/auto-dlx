...
def extract_episode_number(filename):
    ...
    # Pattern 3: Steins Gate 0 - S2 E17 [Dual] 2160p @Anime_Fair.mkv
    pattern3 = re.compile(r'S\d+\s*[E|EP]\s*(\d+)', re.IGNORECASE)

    # Pattern 4: Episode Number After "E" or "EP" with words
    pattern4 = re.compile(r'[E|EP]\s*(\d+)', re.IGNORECASE)

    # Pattern 5: Episode Number After "-"
    pattern5 = re.compile(r'-\s*(\d+)', re.IGNORECASE)
